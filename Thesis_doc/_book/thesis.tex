...
compare against Felix and Fanny. A logistic lasso, k-nearest neighbors,
random forests, naive Bayes, and linear discriminant analysis were
preformed. Comparing between Bach and Menelssohn, --- model resulted in
the lowest misclassification rate. Between Felix and Fanny --- model
resulted in the lowest misclassification rate. Finally the six disputed
pieces were run through the models. and \ldots{}
}
...
into groups (composer) based on similarities in the observations. The
...
As the log(lambda) increases, the coefficients of each of the features
