...
\begin{figure}
\centering
\includegraphics{images/corrfanny.png}
\caption{\label{fig:unnamed-chunk-10}Felix/Fanny Correlations}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/fPCA.png}
\caption{\label{fig:unnamed-chunk-11}PCA felix/fanny}
\end{figure}
\begin{figure}
\centering
\includegraphics{images/fpca_skree.png}
\caption{\label{fig:unnamed-chunk-12}Felix/Fanny skree plot}
\end{figure}
...
Learning} (James, Witten, Hastie, \& Tibshirani, 2013) .We denote the
features \(X\), where \(X_i\) is a certain feature. We have \(p\)
features. Each song has a composer or response, known or unknown,
denoted by \(Y\). In our case we have
...
When a lasso logistic classifier was fit, we got a mean standard error
(MSE) of 0.154. We see that the density features stayed in the longest.
\begin{figure}
\centering
\includegraphics{images/lasso_bach.png}
\caption{\label{fig:unnamed-chunk-13}Lasso Bach/Mendelssohn}
\end{figure}
...
Most commonly our models incorrectly predict Mendelssohn songs to be
composed by Bach.
...
When a lasso classifier was fit, we got a MSE of 0.35. We see that the
density features and fifth scale degree stayed in the longest.
\begin{figure}
\centering
\includegraphics{images/lassofelix.png}
\caption{\label{fig:unnamed-chunk-14}Lasso Fanny/Felix}
\end{figure}
