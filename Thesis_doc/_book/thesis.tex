...
\caption{\label{fig:unnamed-chunk-6}Felix/Fanny Correlations}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-7}PCA felix/fanny}
\end{figure}
\begin{figure}
\centering
\includegraphics{images/fpca_skree.png}
\caption{\label{fig:unnamed-chunk-8}Felix/Fanny skree plot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-9}Lasso Bach/Mendelssohn}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-10}Lasso Fanny/Felix}
\end{figure}
