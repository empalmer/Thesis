...
\caption{\label{fig:unnamed-chunk-1}Felix/Fanny Correlations}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-2}PCA felix/fanny}
\end{figure}
\begin{figure}
\centering
\includegraphics{images/fpca_skree.png}
\caption{\label{fig:unnamed-chunk-3}Felix/Fanny skree plot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-4}Lasso Bach/Mendelssohn}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-5}Lasso Fanny/Felix}
\end{figure}
