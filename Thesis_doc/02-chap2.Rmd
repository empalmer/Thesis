...
We then need to convert into a format more easily readable into R. We do this by using Humdrum's function xml2hum that converts a musicXML file into a .krn file. This file time can be read much more easily into R. Compared to above, the code for a single middle c whole note would be : 
